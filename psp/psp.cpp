...
/*
  ...
  This file is based on snes9x-1.52-src.tar.bz2 (unix/unix.cpp)
 */
...
static void InitJoysticks (void)
{
	...
	ASSIGN_BUTTONf(kPSPCMapPad1PX, "Joypad1 X");
	ASSIGN_BUTTONf(kPSPCMapPad1PA, "Joypad1 A");
	ASSIGN_BUTTONf(kPSPCMapPad1PB, "Joypad1 B");
	ASSIGN_BUTTONf(kPSPCMapPad1PY, "Joypad1 Y");
	ASSIGN_BUTTONf(kPSPCMapPad1PL, "Joypad1 L");
	ASSIGN_BUTTONf(kPSPCMapPad1PR, "Joypad1 R");
	ASSIGN_BUTTONf(kPSPCMapPad1PSelect, "Joypad1 Select");
	ASSIGN_BUTTONf(kPSPCMapPad1PStart, "Joypad1 Start");
	ASSIGN_BUTTONf(kPSPCMapPad1PUp, "Joypad1 Up");
	ASSIGN_BUTTONf(kPSPCMapPad1PDown, "Joypad1 Down");
	ASSIGN_BUTTONf(kPSPCMapPad1PLeft, "Joypad1 Left");
	ASSIGN_BUTTONf(kPSPCMapPad1PRight, "Joypad1 Right");
...
static void ReadJoysticks (void)
{
	...
	S9xReportButton(kPSPCMapPad1PX, psppad.Buttons & PSP_CTRL_SQUARE);
	S9xReportButton(kPSPCMapPad1PA, psppad.Buttons & PSP_CTRL_CIRCLE);
	S9xReportButton(kPSPCMapPad1PB, psppad.Buttons & PSP_CTRL_CROSS);
	S9xReportButton(kPSPCMapPad1PY, psppad.Buttons & PSP_CTRL_TRIANGLE);
	S9xReportButton(kPSPCMapPad1PL, psppad.Buttons & PSP_CTRL_LTRIGGER);
	S9xReportButton(kPSPCMapPad1PR, psppad.Buttons & PSP_CTRL_RTRIGGER);
	S9xReportButton(kPSPCMapPad1PSelect, psppad.Buttons & PSP_CTRL_SELECT);
	S9xReportButton(kPSPCMapPad1PStart, psppad.Buttons & PSP_CTRL_START);
	S9xReportButton(kPSPCMapPad1PUp, psppad.Buttons & PSP_CTRL_UP);
	S9xReportButton(kPSPCMapPad1PDown, psppad.Buttons & PSP_CTRL_DOWN);
	S9xReportButton(kPSPCMapPad1PLeft, psppad.Buttons & PSP_CTRL_LEFT);
	S9xReportButton(kPSPCMapPad1PRight, psppad.Buttons & PSP_CTRL_RIGHT);
}
...
static void set_datadir(char *s, char *d)
{
	char *p;
...
{
	// set current directory to defalut_dir
	set_datadir(argv[0], default_dir);
...
//	xxxxx S9xLoadConfigFiles(argv, argc);
//	xxxxx rom_filename = S9xParseArgs(argv, argc);
	rom_filename = "hoge.smc";
